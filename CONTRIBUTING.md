# Contributing to cam-source-enums

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cam-source-enums. These guidelines are not strict rules.
...
The cam-source-enums team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cam-source-enums technical leads
...
[issues]: https://github.com/include-dcc/cam-source-enums/issues/
[pulls]: https://github.com/include-dcc/cam-source-enums/pulls/
